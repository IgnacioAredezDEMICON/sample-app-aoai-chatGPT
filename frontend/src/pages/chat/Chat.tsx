                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Welcome to the TU Wien University Chat</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>I am an assistant ready to help you with your questions related to your registration and the necessary documents.</h2>
                            </Stack>
                        ) : (
